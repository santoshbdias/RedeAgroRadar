...
**RedeAgroRadar** é um pacote R desenvolvido para o monitoramento em tempo real de radares meteorológicos e envio de alertas automatizados. Ele facilita a análise de imagens do Simepar (Paraná, Brasil) para identificar áreas de chuva e notificar grupos de pesquisa ou produtores via **Telegram**.
...
Com o R instalado, você pode instalar a versão de desenvolvimento diretamente do GitHub:
